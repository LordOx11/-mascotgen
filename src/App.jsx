  ...
  return (
    <div className="rounded-xl border p-5 md:p-8 max-w-3xl mx-auto" style={{ backgroundColor: PANEL, borderColor: "#2A2733" }}>
      ...
      <S n="14" title="Roadmap">
        <B>Live now:</B> the Studio, the saga engine in 9 languages, artwork and video generation, NFT minting on Solana with permanent Arweave storage, the Battle Arena, the 🏁 Death Race circuit, Meme Wars canon, the Graveyard, 🛡 The Legion collection gallery, the public Stats page, and the Founding 333.
        <br /><br />
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card
          ...
          features={[
            ...
            "⚔️ Battle Arena + 🏁 Death Race — unlimited play, no fees",
        ...
        <Card
          ...
          features={[
            ...
            "1 NFT mint (one-time, does not refill) — your ticket into the Arena and Death Race",
      ...
      <p className="text-xs mt-4 p-3 rounded-lg" style={{ backgroundColor: "rgba(94,201,255,0.06)", color: MUTED }}>
        <strong style={{ color: OFFWHITE }}>About the games:</strong> the ⚔️ Battle Arena and 🏁 Death Race are free to play with no entry fees, no wagering, and no limit on how often you play — but you fight and race with <em>minted</em> mascots, so you need at least one NFT mint to take part. Any paid plan includes mints.
      </p>
...
const GAMEPLAY_GUIDE = [
  ...
  {
    key: "race",
    title: "🏁 Death Race — Combat Racing",
    pts: [

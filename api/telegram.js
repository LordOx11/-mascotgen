...
PLANS: Free ($0 — 5 lifetime AI generations, full battle card, both games, 9 languages, no minting). Starter ($11 one-time — 15 generations, 1 mint, origin story, Story Studio). Platinum ($33 per 30-day cycle — 5 generations/day, 5 mints, elite attributes, Trending Mode, crossover sagas, 3% Legendary odds). Elite ($77 per 30-day cycle — 10 generations/day, 10 mints, all auras, 7% Legendary odds). Extra-mint packs ($19.99, Elite only) and art credit packs available. Full details on the Pricing page.
